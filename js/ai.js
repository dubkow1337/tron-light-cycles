...
function aiMove() {
    ...
    // ============================================================
    // ===== ДВИЖЕНИЕ БОТА (только замедление, НЕ ускорение) =====
    // ============================================================
    // Бот двигается с обычной скоростью, но если есть замедление — медленнее
    const moveSpeed = 1 * speedMultiplier; // 1 — норма, 0.5 — замедление
